...
@implementation GPUEffectBokehileVintage2
...
- (UIImage*)process
{
    ...
    self.effectId = EffectIdBokehileVintage2;
    ...
    @autoreleasepool {
        ...
        [selectiveColor setYellowsCyan:-100 Magenta:100 Yellow:-50 Black:0];
    ...
    @autoreleasepool {
        ...
        resultImage = [self mergeBaseImage:resultImage overlayFilter:solidColor opacity:0.3f blendingMode:MergeBlendingModeExclusion];
    }
    ...
    @autoreleasepool {
        ...
        resultImage = [self mergeBaseImage:resultImage overlayFilter:curveFilter opacity:0.14f blendingMode:MergeBlendingModeSoftLight];
    }
    ...
    @autoreleasepool {
        ...
        resultImage = [self mergeBaseImage:resultImage overlayFilter:solidColor opacity:0.3f blendingMode:MergeBlendingModeDifference];
    }
