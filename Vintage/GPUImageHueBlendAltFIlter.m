//
//  GPUImageHueBlendAltFIlter.m
//  Vintage
//
//  Created by SSC on 2014/03/29.
...
NSString *const kGPUImageHueBlendAltFragmentShaderString = SHADER_STRING
(
...
@implementation GPUImageHueBlendAltFIlter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageHueBlendAltFragmentShaderString]))
    {
		return nil;
    }
